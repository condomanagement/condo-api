...
class SimpleCov::Formatter::Console
  # source://simplecov-console//lib/simplecov-console.rb#140
  def branches_missed(missed_branches); end

  # source://simplecov-console//lib/simplecov-console.rb#204
  def colorize(s); end

  # source://simplecov-console//lib/simplecov-console.rb#56
  def format(result); end

  # source://simplecov-console//lib/simplecov-console.rb#40
  ...
  #
  # source://simplecov-console//lib/simplecov-console.rb#151
  def missed(missed_lines); end

  # source://simplecov-console//lib/simplecov-console.rb#196
  def pct(number); end

  # @return [Boolean]
  #
  # source://simplecov-console//lib/simplecov-console.rb#51
  def show_branch_coverage?(result); end

  # Truncate string to at most N chars (as defined by missing_len)
  #
  # source://simplecov-console//lib/simplecov-console.rb#186
  def trunc(str); end

  # @return [Boolean]
  #
  # source://simplecov-console//lib/simplecov-console.rb#200
  def use_colors?; end
